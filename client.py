...
class GUI:
    ...
    def layout(self,name):
        ...
        self.labelBottom.place(relwidth=1,relheight=0.825)
        ...
        self.buttonMsg=Entry(self.labelBottom,text="send",bg="#abb2b9",font="helvetica 10 bold",width=20,command=lambda:self.sendButton(self.entryMsg.get()))
